	...
	<body>
		...
		<div id="desktop">		
			...
			<div id="play" class="col-sm-12" >
			 <h4 style="color:black; text-align:center; padding-top:3px;">Latest Music Video </a></h4>
			</div><br>
			<?php include 'latest.php';?>			
			<div id="play" class="col-sm-12" >
			 <h4 style="color:black; text-align:center; padding-top:3px;">Popular Music Video </a></h4>
			</div><br>			
			<?php include 'popular.php';?>
			<link href="css/owl.carousel.css" rel="stylesheet">
			<link href="css/owl.theme.css" rel="stylesheet">
			<div id="play" class="col-sm-12" >
			 <h4 style="color:black; text-align:center; padding-top:3px;">Exclusive Music Video</a></h4>
			</div><br>				
			<?php include 'exclusive.php';?>
			<div id="play" class="col-sm-12" >
			 <h4 style="color:black; text-align:center; padding-top:3px;">All Music Video</a></h4>
			</div><br>					
